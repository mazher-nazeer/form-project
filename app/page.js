  ...
  const handleImageUpload = (event, type) => {
    ...
    reader.onload = (e) => {
      ...
      img.onload = () => {
        ...
        localStorage.setItem(type === "hospital" ? "hospitalImage" : "compressedImage", compressedDataUrl);
...
<form onSubmit={handleSubmit} className="space-y-4">
  ...
  <div>
<p>Hosp name</p>
  <input name="hospitalName" placeholder="Hospital Name" className="w-full p-2 border rounded" onChange={handleChange} required />
  </div>
<div>
<p>Hosp address</p>
  <input name="hospitalAddress" placeholder="Hospital Address" className="w-full p-2 border rounded" onChange={handleChange} required />
</div>
<div>
  <p>hospitalContact</p>
  <input name="hospitalContact" placeholder="Hospital Contact" className="w-full p-2 border rounded" onChange={handleChange} required />
</div>
<div>
  <p>Mr No</p>
  <input name="mrNo" placeholder="MR no" className="w-full p-2 border rounded" onChange={handleChange} required />
</div>
...
<div>
  ...
  <input type="date" name="vaccinationDate" placeholder="Vaccination Date" className="w-full p-2 border rounded" onChange={handleChange} required />
</div>
<div>
  <p>validityDate</p>
  <input type="date" name="validityDate" placeholder="Validity Date" className="w-full p-2 border rounded" onChange={handleChange} required />
</div>
<div>
<p>printed On Date</p>
  <input type="datetime-local" name="printedOn" placeholder="Validity Date" className="w-full p-2 border rounded" onChange={handleChange} required />
</div>
  {/* Vaccination Details */}
  ...
  <div>
<p>Physician Name</p>
  <input name="physicianName" placeholder="Physician Name" className="w-full p-2 border rounded" onChange={handleChange} required />
  </div>
...
<Link href={redirectUrl} className="w-full bg-green-500 text-white p-2 rounded" >View Form</Link>
</div>
